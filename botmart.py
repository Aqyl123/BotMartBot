...
async def on_message(message):
	if message.content.startswith('!fleek'):
		...
		embed.add_field(name="Supports:", value="{}".format(supports.capitalize()), inline=False)
	...
	if message.content.startswith('!kilo'):
		...
		embed.add_field(name="Supports:", value="{}".format(supports1), inline=False)
	...
	if message.content.startswith('!cookology'):
		...
		embed.add_field(name="Supports:", value="{}".format(supports2), inline=False)
	...
	if message.content.startswith('!alerts'):
		...
		embed.add_field(name="Supports:", value="{}".format(supports3), inline=False)
	...
	if message.content.startswith('!northcop'):
		...
		embed.add_field(name="Supports:", value="{}".format(supports4), inline=False)
	...
	if message.content.startswith('!resellaio'):
		...
		embed.add_field(name="Supports:", value="{}".format(supports5), inline=False)
